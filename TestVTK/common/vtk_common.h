...
void take_screenshot_renderer(vtkSmartPointer<vtkRenderWindow> *vtkRenderWindow, std::string out_fn, int magnification) {
    ...
    windowToImageFilter->SetScale(magnification); //set the resolution of the output image (3 times the current resolution of vtk render window)
